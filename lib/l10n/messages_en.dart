...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, dynamic> _notInlinedMessages(_) => {
    ...
    'settings_custom_download_path_permission_title': MessageLookupByLibrary.simpleMessage('Storage Permission Required'),
    'settings_custom_download_path_permission_message': MessageLookupByLibrary.simpleMessage('To save downloads to a custom folder outside the app, Anytime requires All Files Access permission.'),
    ...
    'active_downloads_empty_message': MessageLookupByLibrary.simpleMessage('No active downloads or transcoding tasks'),
    ...
    'batch_delete_dialog_message': MessageLookupByLibrary.simpleMessage('Are you sure you want to delete the selected downloaded episodes?'),
